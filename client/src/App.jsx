  ...
  return (
    <div className="app-shell">
      <header className="site-header">
        ...
        <nav><button className={view.page === 'dashboard' ? 'active' : ''} onClick={openDashboard}>Dashboard</button><button className={view.page === 'recommendation' ? 'active' : ''} onClick={openRecommendation}>Recommended</button><button className={view.page === 'library' || view.page === 'details' ? 'active' : ''} onClick={openLibrary}>Library</button></nav>
      </header>
